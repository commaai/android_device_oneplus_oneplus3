...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/audio_platform_info_lepro.xml:system/etc/audio_platform_info_lepro.xml \
    $(LOCAL_PATH)/audio/audio_policy.conf:system/etc/audio_policy.conf \
    $(LOCAL_PATH)/audio/listen_platform_info.xml:system/etc/listen_platform_info.xml \
    $(LOCAL_PATH)/audio/mixer_paths_tasha.xml:system/etc/mixer_paths_tasha.xml \
    $(LOCAL_PATH)/audio/mixer_paths_tashalepro.xml:system/etc/mixer_paths_tashalepro.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/wifi/WCNSS_qcom_cfg_lepro.ini:system/etc/wifi/WCNSS_qcom_cfg_lepro.ini \
